...
public class Init {
    ...
    public static int CANTIDAD_CIUDADES = 100;
    ...
    public static final int CANTIDAD_ITERACIONES = 10;
    //public static final Double RADIO_FITNESS_SHARING = 10.0;

    public static final String NOMBRE_ARCHIVO1 = "/home/lg_more/MEGAsync/maestria/AE2016CD/tp3/trabajoPractico3Maven/manyObjectiveAco/kroab1.txt";
    public static final String NOMBRE_ARCHIVO2 = "/home/lg_more/MEGAsync/maestria/AE2016CD/tp3/trabajoPractico3Maven/manyObjectiveAco/kroab2.txt";
    public static Hormiga mejorGlobal = null;

    public static ArrayList<ArrayList<Double>> ciudades1;
    public static ArrayList<ArrayList<Double>> ciudades2;
    public static ArrayList<ArrayList<Double>> feromonas1;
    public static ArrayList<ArrayList<Double>> feromonas2;
    public static ArrayList<ArrayList<Double>> visibilidades1;
    public static ArrayList<ArrayList<Double>> visibilidades2;
    ...
    public static ArrayList<ArrayList<Double>> leerArchivo2() {
        Scanner in;
        ArrayList<ArrayList<Double>> resultado = new ArrayList<>();

        try {
            Scanner s = new Scanner(new File(NOMBRE_ARCHIVO2));
            int elementos = 0;
            int row = 0;
    ...
    public static ArrayList<ArrayList<Double>> leerArchivo1() {
        Scanner in;
        ArrayList<ArrayList<Double>> resultado = new ArrayList<>();

        try {
            Scanner s = new Scanner(new File(NOMBRE_ARCHIVO1));
            int elementos = 0;
            int row = 0;
            //int matrix[][] = new int[rows][columns];
            resultado.add(new ArrayList<>());
    ...
    public static ArrayList<ArrayList<Double>> inicializarFeromonas1() {
        Scanner in;
        ArrayList<ArrayList<Double>> resultado = new ArrayList<>();
    ...
    public static ArrayList<ArrayList<Double>> inicializarFeromonas2() {
        Scanner in;
        ArrayList<ArrayList<Double>> resultado = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        feromonas1 = inicializarFeromonas1();
        feromonas2 = inicializarFeromonas2();
        visibilidades1 = inicializarVisibilidades(ciudades1);
        visibilidades2 = inicializarVisibilidades(ciudades2);
...
//        }
    ...
    private static void actualizarFeromonas1(ArrayList<Hormiga> hormigas) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        int fila, columna = 0;
        ...
        for (fila = 0; fila < Init.CANTIDAD_CIUDADES - 1; fila++) {
            ...
            for (columna = fila + 1; columna < Init.CANTIDAD_CIUDADES; columna++) {
                ...
                Double deltaTau = getDeltaTau1(fila, columna, hormigas);

                Double feromona = (1 - Init.COEFICIENTE_EVAPORACION) * Init.feromonas1.get(fila).get(columna);

                feromona += deltaTau;

                Init.feromonas1.get(fila).set(columna, feromona);
                Init.feromonas1.get(columna).set(fila, feromona);
    ...
    private static void actualizarFeromonas2(ArrayList<Hormiga> hormigas) {
        ...
        for (fila = 0; fila < Init.CANTIDAD_CIUDADES - 1; fila++) {
            ...
            for (columna = fila + 1; columna < Init.CANTIDAD_CIUDADES; columna++) {
                ...
                Double deltaTau = getDeltaTau2(fila, columna, hormigas);

                Double feromona = (1 - Init.COEFICIENTE_EVAPORACION) * Init.feromonas2.get(fila).get(columna);

                feromona += deltaTau;

                Init.feromonas2.get(fila).set(columna, feromona);
                Init.feromonas2.get(columna).set(fila, feromona);
    ...
    private static Double getDeltaTau1(Integer ciudadActual, Integer siguienteCiudad, ArrayList<Hormiga> hormigas) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        ...
        for (Hormiga hormiga : hormigas) {
            ...
            if (indiceCiudadActual + 1 == indiceCiudadSiguiente
                ...
                resultado += Q / getCostoTour1(hormiga);
            } else {
                //nada
            }
    ...
    private static Double getDeltaTau2(Integer ciudadActual, Integer siguienteCiudad, ArrayList<Hormiga> hormigas) {
        //throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        //verificar si la hormiga uso el tour
        Double resultado = 0.0;
        for (Hormiga hormiga : hormigas) {
            ...
            if (indiceCiudadActual + 1 == indiceCiudadSiguiente
                ...
                resultado += Q / getCostoTour2(hormiga);
            } else {
                //nada
            }
    ...
    private static Double getCostoTour1(Hormiga hormiga) {
        ...
        for (Integer ciudad : hormiga.ciudades) {
            ...
            resultado += Init.ciudades1.get(ciudadActual).get(ciudadSiguiente);
    ...
    private static Double getCostoTour2(Hormiga hormiga) {
        ...
        for (Integer ciudad : hormiga.ciudades) {
            ...
            ciudadSiguiente = ciudad;
            resultado += Init.ciudades2.get(ciudadActual).get(ciudadSiguiente);
            ciudadActual = ciudadSiguiente;
